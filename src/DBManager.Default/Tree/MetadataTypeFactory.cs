...
namespace DBManager.Default.Tree
{
	...
	{
		protected IReadOnlyDictionary<MetadataType, Func<DbDataReader, DbObject>> _creator;

		public abstract DialectType Dialect { get; }

		protected MetadataTypeFactory(Dictionary<MetadataType, Func<DbDataReader, DbObject>> creators)
		{
			_creator = creators;
		}
